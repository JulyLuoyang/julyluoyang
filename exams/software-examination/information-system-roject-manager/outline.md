...
- **存储与数据库**：
  ...
  - 数据结构模型
    - 层次模型：用“树”结构表示实体集之间的关联
    - 网状模型：用网状结构表示实体类型及实体之间的联系
    - 关系模型：二维表格
  - 数据库类型：
    - 关系型（ACID原则）
    - 非关系型（键值/列存储/文档/图数据库）
  - 数据仓库
    - 数据源：基础
    - 数据的存储和管理：核心
    - 联机分析处理（OLAP）：可以分为OLAP、MOLAP、HOLAP
    - 前端工具
- **信息安全**：
  - 基础属性：保密性、完整性、可用性（可玩宝）
  - 技术：加密解密（对称/非对称）、UEBA（用户行为分析）、态势感知

### 2.2 新一代信息技术

- **物联网**：
  - 架构：感知层（传感器，包括二维码）、网络层（通信）、应用层（场景）
...
- 体系框架：IT战略目标、IT治理组织、IT治理机制、IT治理域、IT治理标准、IT绩效目标
...
- ITSS中IT服务治理：通用要求、实施指南
  - GB/T 34960.1 标准定义的IT治理框架![alt text](image-18.png)
...
- **数据管理**
  - 数据管理能力成熟度评估模型：包含8个能力域：数据战略、治理、架构、应用、安全、质量、标准、生命周期![alt text](image-19.png)
  - 数据战略：规划、实施、评估
  - 数据治理：组织、制度建设、沟通
  ...
  - 数据生存周期：数据需求、数据设计开发、数据运维、数据退役
  - 理论框架和成熟度
    - 数据管理能力成熟度模型（DCMM）
      - 初始级：数据需求的管理主要是在项目级体现，没有同意的管理流程，主要是被动式管理
      - 受管理级：组织意识到数据是资产，根据管理策略的要求制定了管理流程，制定了相关人员进行初步管理
      - 稳健级：数据已被当作实现组织绩效目标的重要资产，在组织层面制定了系列的标准化管理流程，促进数据管理的规范化
      - 量化管理级：数据被认为是获取竞争优势的重要资源，数据管理的效率能量化分析和监控
      - 优化级：数据被认为是组织生存和发展的基础，相关管理流程能实施优化，能在行业内进行最佳实践分享
- **运维管理**
...
- **信息安全管理**
  ...
  - 网络安全等级保护：五级划分、安全保护能力要求
    - 第一级：来自个人、拥有很少资源的威胁源，...在自身遭到损害后，能够恢复部分功能
    - 第二级：来自外部小型组织、拥有少量资源的威胁源，...在自身遭到损害后，能够在一段时间内恢复部分功能
    - 第三级：来自外部有组织的团体、拥有较为丰富资源的威胁源，...在自身遭到损害后，能够较快恢复绝大部分功能
    - 第四级：来自国家级别的、敌对组织、拥有丰富资源的威胁源，...在自身遭到损害后，能够迅速恢复所有功能
    - 第五级：略
...
- **架构设计**
  - 软件架构风格：数据流、调用/返回、独立构件、虚拟机、仓库风格![alt text](image-15.png)
  - 软件架构评估
    - 敏感点：一个或多个构件（或之间的关系）的特性
    ...
    - 评估方式
      ...
      - 基于度量的方式
- **需求分析**
  - 需求层次：业务需求、用户需求、系统需求；QFD将软件需求分为三类：常规需求、期望需求、意外需求
  - 需求过程：获取、分析、规格说明书编制、验证与确认
  - UML
    - 事物
      - 结构事物：在模型中属于最静态的部分，代表概念上或物理上的元素
      - 行为事物：是UML模型中的动态部分，代表时间和空间上的动作
      - 分组事物：是UML模型中组织的部分，可以把他们看成是个盒子，模型可以在其中进行分解
    - 关系
...
- **组织系统**：治理框架、管理要素、组织结构类型（职能型、矩阵型、项目导向型等）![alt text](image-16.png)
...
- **项目生命周期**
  - 通用结构：启动、组织与准备、执行、结束
  - 生命周期类型：预测型（计划驱动型）、迭代型、增量型、适应型（敏捷型）、混合型![alt text](image-17.png)
- **项目管理过程组（骑龟直行监收）**
  - 启动过程组：定义新项目或阶段
  - 规划过程组：明确目标并制定计划
  - 执行过程组：完成计划中的工作
  - 监控过程组：跟踪和调整项目进展
  - 收尾过程组：正式完成项目或阶段
- **项目管理知识领域（整范进，成质子，狗风采购干）**
  - 整合管理、范围管理、进度管理、成本管理、质量管理、资源管理、沟通管理、风险管理、采购管理、干系人管理
- **项目绩效域（干团开发生，规工交测不定）**
...
- 概念：立项申请又叫项目建议书，项目建设单位提交的框架性总体设想
...
- **内容**
  ...
  - 经济可行性：支出分析、收益分析、收益投资比and投资回收期分析、敏感性分析
...
- **初步可行性研究**
  ...
  - 内容：需求与市场预测、设备与资源投入分析、空间布局、项目设计、项目进度安排、项目投资与成本估算
- **详细可行性研究**
  - 定义：全面调查分析技术、经济、社会等条件
  - 依据：法律法规、规划、项目建议书等
  - 原则：科学性、客观性、公正性
  - 方法：经济评价法、市场预测法、投资估算法、增量净效益法
  - 内容：市场需求预测、部件和投入的选择供应、详细系统架构及技术方案的确定、技术设备选择、网络物理布局设计、（投资、成本估算与资金筹措）、经济评价及综合分析、综合分析
...
- 开展频率
  - 仅开展一次或仅在项目的预定义时开展
- 项目经理
  - 应在规划之前任命，越早确认并任命越好，最好在制定项目章程时就任命
- 编写人
  - 项目发起人，也可由项目经理与发起机构合作编制
- 项目章程一旦被批准，就标志着项目的正式启动
- 项目由项目以外的机构来启动，例如发起人、项目集或项目管理办公室（PMO）等
- 输入
  - 立项管理文件（一般包含商业需求和成本效益分析，论证项目的合理性并确定项目边界）
  - 协议（包括合同、谅解备忘录、服务水平协议等）
  - 事业环境因素
  - 组织过程资产
- 工具与技术
  - 专家判断
...
域子管理计划和基准，以及管理项目所需的其他组件信息，项目管理计划的组件取决于项目的具体需求
    - 主要包括子管理计划、基准、其他组件
...
- 输入
  ...
  - 项目文件
  - 批准的变更请求
    - 变更控制委员会（CCB）由项目所涉及的主要干系人组成，通常包括用户和项目所在组织管理层的决策人员。CCB是决策机构，不是作业机构
  - 事业环境因素
  - 组织过程资产
- 工具与技术
  - 专家判断
...
- 输出
  ...
  - 工作绩效数据
  - 问题日志
    - 主要包括问题类型、问题提出者和提出时间、问题描述、问题优先级、解决问题负责人、目标解决日期、问题状态、最终解决情况
  - 变更请求
...
- 输出
  - 工作绩效报告
    - 一般包括状态报告和进展报告
    - 包含内容：挣值图表和信息、趋势线和预测、储备燃尽图、缺陷直方图、合同绩效信息和风险情况概述。也可以表示为引起关注、制定决策和采取行动的仪表指示图、热点报告、信号灯图或其他形式
  - 变更请求
  - 项目管理计划（更新）
  - 项目文件（更新）
...
- **产品范围 vs 项目范围**
  - 产品范围：指某项产品、服务或成果的特性和功能。其完成情况是根据产品需求来衡量的
  - 项目范围：包含产品范围，是为交付具有规定特性与功能的产品、服务或成果而必须完成的工作。其完成情况是跟据项目管理计划衡量
- **管理新实践**
  - 与商业分析师合作，需求管理延伸至移交后
  - 伙伴式合作关系，确保需求与商业目标一致
...
- **输出**
  - 需求文件
    - 需求的类别
      - 业务需求：整个组织的高层级需要
      - 干系人需求：干系人的需要
      - 解决方案需求（功能需求和非功能需求）：为满足业务需求和干系人需求，产品、服务或成果必须具备的特性、功能和特征
      - 过度和就绪需求：如数据转换和培训需求
      - 项目需求：项目需要满足的行动、过程或其他条件，如里程碑日期、合同责任、制约因素等
      - 质量需求：用于确认项目可交付成果的成功完成或其他项目需求的实现的任何条件或标准
  - 需求跟踪矩阵
    - 把产品需求从其来源连接到能满足需求的可交付成果的一种表格
    - 跟踪需求的内容包括：①业务需要、机会、目的和目标：②项目目标； ③项目范围和 WBS 可交付成果；④产品设计；⑤产品开发：⑥测试策略和测试场景：⑦高层级需求到详细需求等
...
- **工具与技术**
  ...
  - 人际关系与团队技能
    - 引导
  - 产品分析
    - 产品分析技术主要包括产品分解、需求分析、系统分析、系统工程、价值分析、价值工程等
- **输出**
  - ❗项目范围说明书
    - 产品范围描述
    - 可交付成果
...
- **工具与技术**
  - 专家判断
  - 分解
    - 方法：自上而下、使用组织特定的指南、使用WBS模板、自下而上（可用于归并较低层次的组件）
    - WBS最低层组成部分称作工作包
    - 要把整个项目工作分解为工作包，通常需要开展如下活动
      ...
      - 为WBS组成部分制定和分配标识编码
      - 核实可交付成果分解的程度是否恰当
    - 表现形式：提纲式、组织结构图或能说明层级结构的其他形式
    - 滚动式规划
    - ❗注意事项
      - WBS必须是面向可交付成果的
      - WBS必须符合项目的范围
      - WBS的底层应该支持计划和控制
      - WBS必须有人负责，而且只能是1人负责（WBS和责任人可以使用工作责任矩阵来描述）
      - WBS应该控制在4-6层（一个工作单元只能从属于某个上层单元，避免交叉从属）
      - WBS包括项目管理工作，也包括分包出去的工作
      - WBS的编制需要所有（主要）项目干系人的参与
      - WBS并不是一成不变的
- **输出**
  - 范围基准
    - 定义：经过批准的范围说明书、WBS、WBS字典（是针对WBS中的每个组件，详细描述可交付成果、活动和进度信息的文件）
  - 项目文件（更新）
    - 假设日志、需求文件
...
- **确认范围与控制质量**
  ...
  - 前者关注可交付成果的验收，而后者关注可交付成果的正确性及是否满足质量要求。控制质量过程通常先于确认范围过程，但二者也可同时进行
...
- **输出**
  - 进度管理计划
    - 含进度模型、迭代长度、控制临界值等，可以是正式或非正式，详细或概括
...
- **工具与技术**
  - 紧前关系绘图法（PDM，又叫前导图或单代号网络图）
    - 四种关系
      - 结束-开始（FS）：前置活动必须在后续活动开始之前完成
      - 开始-开始（SS）：前置活动必须在后续活动开始之前开始
      - 结束-结束（FF）：前置活动必须在后续活动完成之前完成
      - 开始-结束（SF）：前置活动必须在后续活动完成之前开始
  - 箭线图法（ADM，也叫双代号网络图）
  - 确定和整合依赖关系
    - 强制性依赖关系：法律、合同或工作内在性质决定的依赖关系
    - 选择性依赖关系：基于具体应用领域的最佳实践或项目的特殊性质对活动顺序的要求来创建
    - 外部依赖关系：项目活动与非项目活动之间的依赖关系
    - 内部依赖关系：项目活动之间的紧前关系
  - 提前量/滞后量
    - 提前量：相对于前置活动，后续活动可以提前的时间，一般用负值表示
    - 滞后量：相对于前置活动，后续活动需要推迟的时间，一般用正值表示
  - 项目管理信息系统
    - 项目管理信息系统软件

- **输出**
  - 项目进度网络图![alt text](image-22.png)
  - 项目文件（更新）
...
- **工具与技术**
  ...
  - 自下而上估算
  - 数据分析
    - 备选方案、储备分析（应急储备——已知-未知，管理储备——未知-未知）
  - 决策
  - 会议
...
- **工具与技术**
  ...
  - 资源优化
    ...
    - 资源平滑：不会改变项目的关键路径，完工日期也不会延迟，但可能无法实现所有资源的优化
  - 数据分析：假设情景分析/模拟（蒙特卡罗模拟）
  - 提前量和滞后量
  - 进度压缩：赶工（增加资源）、快速跟进（并行活动），二者都可能增加项目风险和成本
    - 当出现进度落后，成本节约的情况，需要采取的措施有
...
- **输出**
  - 进度基准：经过批准的进度模型
  - 项目进度计划
    - 至少包括每个活动的计划开始日期和完成日期，可以是详细或概括，形式可以是列表或图形（横道图（甘特图）、里程碑图）、项目进度网络图（包含时间可读的叫时标图）
  - 进度数据
  - 项目日历（可用工作日和工作班次）
  - 变更请求
  - 项目管理计划（更新）
...
- **发生成本失控的原因**
  ...
  - 需求管理不当
- **相关术语**
  - 可变成本、固定成本、直接成本、间接成本、机会成本、沉没成本（不可控）
  - 应急储备
    - 应对已知-未知风险
    - 是包含在进度基准中的一段持续时间，应在项目进度文件中清楚的列出
    - 是包含在成本基准内的一部分预算
  - 管理储备
    - 应对未知-未知风险
    - 不包括在进度基准中，但属于项目总持续时间的一部分
    - 不包括在成本基准中，但属于项目总预算和资金需求的一部分，使用前需要得到高层管理者的批准
    - 不属于PV和BAC
    - 当动用管理储备资助不可预见的工作时，就要把动用的管理储备增加到成本基准中，此时会导致成本基准的变更
  - 成本基准
    - 是经批准的按时间安排的成本支出计划，并随时反映了经批准的项目成本的变更，被用于度量和监督项目的实际执行成本
    - 含应急储备，不含管理储备
    - 是不同进度活动经批准的预算的总和
    - ![alt text](image-11.png)
    - 对于使用挣值管理的项目，成本基准指的是绩效测量基准![alt text](image-12.png)
- **新实践**：挣得进度（ES）扩展挣值管理（EVM），用于进度偏差测量

### 11.2 项目成本管理过程

- **过程概述**
- **裁剪考虑因素**：知识管理、估算与预算、挣值管理、敏捷方法的使用、治理
- **敏捷与适应方法**：轻量级估算应对易变项目；详细的估算适用于采用准时制的短期计划；频繁调整范围和进度计划以控制成本

### 11.3 规划成本管理

- **输入**：项目章程、项目管理计划（进度管理计划、风险管理计划）、事业环境因素、组织过程资产
- **工具与技术**：专家判断、数据分析（备选方案分析）、会议
- **输出**、
  - 成本管理计划
    - 是项目管理计划的组合部分，描述将如何规划、安排和控制项目成本
    - 含计量单位、精确度、准确度、组织程序链接、控制临界值、绩效测量规则、报告格式、其他细节等

### 11.4 估算成本

- **输入**：项目管理计划、项目文件、事业环境因素、组织过程资产
- **工具与技术**：专家判断、类比估算、参数估算、自下而上估算、三点估算（三角分布和贝塔分布）、数据分析（备选方案分析/储备分析/质量成本）、项目管理信息系统、决策（投票）
- **输出**：成本估算（应覆盖项目所使用的全部资源）、估算依据、项目文件（更新）
...
- **工具与技术**
  ...
  - 资金限制平衡
  - 融资
- **输出**：成本基准、项目资金需求、项目文件（更新）

### 11.6 控制成本

- **输入**：项目管理计划、项目资金需求、项目文件、工作绩效数据、组织过程资产
- **工具与技术**：专家判断、数据分析（挣值分析、偏差分析、趋势分析（图表和预测）、储备分析）、完工尚需绩效指数（TCPI）、项目管理信息系统
...
- **质量与项目质量**
  ...
  - 项目质量
    - 从项目作为一次性的活动来看，项目质量体现在工作质量；从项目作为一项最终产品来看，项目质量体现在产品质量
...
- **质量管理标准体系**
  - GB/T 19000系列标准
  - 全面质量管理（TQM）
    - 4要素组成：结构、技术、人员和变革推动者
    - 4核心特征：全员参加的质量管理；全过程的质量管理；全面方法的质量管理；全面结果的质量管理
- **管理新实践**：客户满意、持续改进、管理层的责任、与供应商的互利合作关系

### 12.2 项目质量管理过程

- **过程概述**
- **裁剪考虑因素**：政策合规与审计、标准与法规合规性、持续改进、干系人参与
- **敏捷与适应方法**：待办
...
- **工具与技术**
  - 专家判断
  - 数据收集（标杆对照、头脑风暴、访谈）
  - 数据分析（成本效益分析、质量成本![alt text](image-14.png)）
  - 决策技术（多标准决策分析）
...
- **工具与技术**
  ...
  - 数据表现
    ...
    - 因果图（鱼骨图、why-why分析图、石川图）：有助于识别问题的主要原因或根本原因
    - 流程图：展示引发缺陷的一系列步骤
    - 直方图
    - 矩阵图：矩阵图在行列交叉的位置展示因素、原因和目标之间的关系强弱
    - 散点图：展示两个变量之间的关系
  - 审计（由项目外部的团队开展）
  - 面向X的设计：DfX，可以降低成本，改进质量，提高绩效和客户满意度
  - 问题解决
  - 质量改进方法：执行-实施-检查-行动（PDCA）和六西格玛
- **输出**
  - 质量报告
  - 测试与评估文件、
  - 变更请求
...
- **工具与技术**：数据收集（核对单、核查表、统计抽样、问卷调查）、数据分析（绩效审查、根本原因分析（RAC））、检查、测试/产品评估、数据表现（因果图、控制图、直方图、散点图）、会议

- **输出**：工作绩效信息、质量控制测量结果（书面记录）、核实的可交付成果、变更请求、项目管理计划（更新）、项目文件（更新）

## 第13章 项目资源管理

### 13.1 管理基础

- **相关术语和定义**：项目团队、项目管理团队、项目经理、领导与管理、权力、冲突与竞争、团队发展阶段、激励理论（马斯洛、赫茨伯格、X理论、Y理论、期望理论）
- **管理新实践**：资源管理方法、情商（EI）、自组织团队、虚拟团队

### 13.2 项目资源管理过程

- **过程概述**
- **裁剪考虑因素**：多元化、物理位置、行业特定资源、团队成员的获得、团队管理、生命周期方法
- **敏捷与适应方法**
...
- **工具与技术**
  - 专家判断
  - 数据表现
    - 层级型（工作分解结构WBS、组织分解结构OBS、资源分解结构）
    - 矩阵型
      - 展示项目资源在各个工作包中的任务分配
      - 一个例子是职责分配矩阵（RAM），这个的一个例子是RACI(R执行，A负责，C咨询，I知情)
    - 文本型
  - 组织理论
  - 会议
- **输出**
  - 资源管理计划：识别资源、获取资源、角色与职责、项目组织图、项目团队资源管理、培训、团队建设、资源控制、认可计划
  - 团队章程：团队价值观、沟通指南、决策标准与过程、冲突处理过程、会议指南和团队共识
  - 项目文件（更新）
...
- **输出**：资源需求、估算依据、资源分解结构（资源依类别和类型的层级展现）、项目文件（更新）
...
- **输入**
  ...
  - 组织过程资产
- **工具与技术**
  - 决策（多标准决策分析，可使用的选择标准有：可用性、成本、能力；有些选择标准对团队资源来说是独特的：经验、知识、技能、态度、国际因素）
  - 人际关系与团队技能（谈判）
  - 预分派
  - 虚拟团队
- **输出**
...
- **定义**
  - 是跟踪团队成员工作表现，提供反馈，解决问题，并管理团队变更以优化项目绩效的过程
...
- **输入**
  ...
  - 团队绩效评价
  - 事业环境因素
  - 组织过程资产（嘉奖证书、组织中其他的额外待遇等）

- **工具与技术**
  - 人际关系与团队技能
    - 冲突管理
      - 撤退/回避
      - 缓和/包容（强调包容）：强调一致而非差异；为维持和谐与关系而退让一部，考虑其他方的需要
      - 妥协/调解（强调调解，可能双输）：为了暂时或部分解决冲突，寻找能让各方都在一定程度上满意的解决方案
      - 强迫/命令（赢-输）：以牺牲其他方为代价，推行某一方的观点
      - 合作/解决问题（双赢）
    - 制定决策：此处决策是指谈判能力以及影响组织与项目管理团队的能力
    - 情商
    - 影响
    - 领导力
  - 项目管理信息系统
...
- **工具与技术**
  - 数据分析
    - 备选方案分析：有助于选择最佳方案以纠正资源使用偏差
    - 成本效益分析：有助于成本出现差异时确定最佳的纠正措施
    - 绩效审查
    - 趋势分析
  - 问题解决
  - 人际关系与团队技能（谈判，影响力）
  - 项目管理信息系统（资源管理和进度计划软件）
...
- **沟通模型**
  ...
  - 5种状态
    - 已发送
    - 已收到：并不代表对方有意图去读取、理解或解决信息
    - 已理解
    - 已认可：并不代表对方同意这个观点
    - 已转化为积极的行动（最难的一环））  
- **沟通分类**：内部/外部、正式/非正式、层级沟通、官方/非官方、书面和口头沟通等
...
- **沟通技巧**
  ...
  - 书面沟通的5C原则
    ...
    - 善用控制语句和承接
  - 其他沟通技巧（积极倾听、文化差异管理）
- **管理新实践**：干系人纳入评审、干系人参加项目会议、社交工具使用、多面性沟通方法
...
- **定义**
  - 基于每个干系人或干系人群体的信息需求、可用的组织资产，以及具体项目的需求，为项目沟通活动制定恰当的方法和计划的过程
...
- **工具与技术**
  ...
  - 会议
- **输出**
  - 项目沟通记录（主要包含绩效报告、可交付成果的状态、进度进展、产生的成本、演示，以及干系人需要的其他信息）
  - 项目管理计划（更新）
  - 项目文件（更新）
  - 组织过程资产更新
...
- **风险的分类**
  - 按后果：纯粹风险（无收益）、投机风险（有收益可能），一定条件下可以相互转化
...
- **开展时机**：在项目立项阶段就应开始，并在项目早期完成。在项目生命周期的后期，可能有必要重新开展本过程
- **输入**
  - 项目章程
  - 项目管理计划：所有已批准的项目管理子计划
  - 项目文件：干系人登记册
  - 事业环境因素
  - 组织过程资产
- **工具与技术**
  ...
  - 会议
- **输出**
  - 风险管理计划：包含风险管理策略、方法论、角色与职责、资金、时间安排、风险类别（借助风险分解结构RBS）、干系人风险偏好、风险概率和影响、概率和影响矩阵、报告格式、跟踪
...
- **开展频率**
  - 在整个项目期间开展；识别风险是一个迭代的过程，迭代的频率和每次迭代所需的参与程度因情况而异，应在风险管理计划中做出相应规定
- **输入**
  - 项目管理计划
  - 项目文件
  - 采购文档
...
- **作用**：重点关注高优先级的风险，对风险进行优先级排序
- **输入**：项目管理计划（风险管理计划）、项目文件、事业环境因素、组织过程资产
- **工具与技术**
  - 专家判断
  - 数据收集：访谈
  - 数据分析
...
- **定义**：是就己识别的单个项目风险和不确定性的其他来源对整体项目目标的影响进行定量分析的过程
- **作用**
  - 量化整体项目风险最大可能性
...
- **工具与技术**
  ...
  - 不确定性表现方式（概率分布）
  - 数据分析
    - 模拟：模拟单个项目风险和其他不确定性来源的综合影响。通常采用蒙特卡洛分析：定量风险分析模型
    - 敏感性分析：确定哪些单个项目风险或不确定性来源对项目结果具有最大的潜在影响。通常用龙卷风图表示
    - 决策树分析：预期货币价值（EMC）
    - 影响图
- **输出**
  - 项目文件（更新）（风险报告）
...
- **工具与技术**
  ...
  - 威胁应对策略
    - 上报
    - 规避：适用于发生概率较高，且具有严重负面影响的高优先级的威胁
    - 转移
    - 减轻
    - 接受（低优先级或无法应对的）
  - 机会应对策略
...
- **输入**
  ...
  - 项目文件
    ...
    - 风险登记册
    - 风险报告
  - 组织过程资产：主要是已完成的类似项目的经验教训知识库，其中会说明特定风险应对的有效性
- **工具与技术**
  - 专家判断
  - 人际关系与团队技能：影响力
  - 项目管理信息系统：可能包括进度、资源和成本软件
- **输出**
  - 变更请求
  - 项目文件（更新）
    - 经验教训登记册
...
- **输出**
  ...
  - **项目管理计划（更新）**：风险管理计划、采购管理计划、进度基准、成本基准
  - **项目文件（更新）**：经验教训登记册、资源需求、需求跟踪矩阵、风险登记册、干系人登记册
  - **组织过程资产更新**：支付计划请求、卖方绩效评估文件、预审合格卖方清单更新、经验教训知识库、采购档案
...
- **合同内容**
  - **基本条款**：项目名称、标的内容和范围、项目的质量要求、项目的计划进度地点地域和方式、项目建设过程中的各种期限、技术情报和资料的保密、风险责任的承担、技术成果的归属、验收的标准和方法、价款报酬及其支付方式、违约金或者损失赔偿的计算方法、解决争议的方法、名词术语解释
...
- **工具与技术**
  - **专家判断**
    ...
    - 需求管理、供应商管理及变更处理经验
  - **沟通技能**
    - 反馈机制（如对话、会议、调查）了解干系人反应，包括正式/非正式沟通方式结合，确保信息有效传递
  - **人际关系与团队技能**
    - 冲突管理：及时解决团队或干系人间的矛盾
    - 文化意识：适应文化差异以促进有效沟通
    - 谈判：获取支持或解决争议
...
- **预期目标**
  ...
  - 全员展现领导力与人际技能
- **绩效要点**
  - **项目团队文化**：透明、诚信、尊重、支持、创新、庆祝成功
  - **高绩效项目团队**：开诚布公的沟通、共识、共享责任、信任、协作、适应性、韧性、赋能、认可
  - **领导力技能**
    - **建立和维护愿景**：清晰、可行、激励性
    - **批判性思维**：基于证据的逻辑分析
    - **激励**：结合内在（成就、成长）与外在（奖励）因素
    - **人际关系技能**：情商（自我意识、管理、社交意识、技能）、冲突管理、决策
- **与其他绩效域的交互**
  - 规划沟通、问题解决、决策制定、持续改进
- **执行效果检查**
...
- **绩效要点**
  ...
  - **开发方法**
    ...
    - **混合型**：结合预测型与适应型，适用于模块化或中风险或需求存在不确定性项目
    - **适应型（敏捷）**：高频迭代，快速响应变更，适合需求高度不确定性和易变性项目
  - **开发方法的选择**
    - **产品因素**：创新程度、需求确定性、变更难度、安全/法规要求
    - **项目因素**：干系人参与度、进度制约、资金可用性
    - **组织因素**：结构、文化、团队规模与分布
  - **协调交付节奏和开发方法**：根据可交付物特性匹配交付节奏与开发方法（如社区中心项目案例）
- **与其他绩效域的交互**
  - 干系人反馈、规划调整、风险应对、团队协作方式
- **执行效果检查**
  - 产品质量与变更成本、价值导向型项目阶段、适宜的交付节奏和开发方法
...
- **绩效要点**
  - **制定有效的度量指标**
    ...
    - **有效度量指标**：具有SMART特征：具体、有意义、可实现、相关性、及时性
  - **度量内容及相应指标**
    - **可交付物**：缺陷数量、技术绩效指标
    - **交付**：在制品、提前期、周期时间
    ...
    - **资源**：利用率与成本偏差
    - **价值**：成本效益比、ROI、NPV
    - **干系人**：净推荐值（NPS）、情绪图、士气调查、离职率
    - **预测型指标**：完工估算（EAC）、回归分析
  - **展示度量信息和结果**
    - **工具**：仪表盘（信号灯图、横道图）、大型可见图表（BVC）、任务板、燃烧图
  - **度量陷阱**：霍桑效应、虚荣指标、士气低落、误用度量指标、确认偏见
...
- **配置管理**
  ...
  - **角色与职责**
    - **配置管理负责人**：也称配置经理，统筹配置管理策略、审计、培训等
...
- **角色与职责**
  ...
  - **项目集指导委员会**：治理支持、决策制定、资源分配、批准项目集收尾和终止。
...
- **22.3.2 数字化转型实施**
  ...
  - **关键步骤**
    - **数字转型准备**
      ...
      - **转型组织建立**：明确责任主体，成立数字化转型团队，构建协同机制。数字化转型组织架构及工作机制的建议可分为4个层次：规划层、实施层、能力层和资源层。
    - **数字化转型策划**
...
- **薪酬调整**
  - 水平调整
    - 按调整性质划分：主动/被动
    - 按调整内容划分：奖励性调整，生活指数性调整，年龄（工龄）性调整，效益性调整
  - 结构调整（等级与构成优化）
