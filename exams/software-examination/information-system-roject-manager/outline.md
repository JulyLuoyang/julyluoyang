...
- **IT治理基础**
  - 驱动因素：解决信息系统建设和运行中的问题，确保IT与组织战略一致
  - 目标价值：与业务目标一致、有效利用信息与数据资源、风险管理
...
- **审计方法与技术**
  - 风险评估技术：风险识别、分析、评价、应对技术
  - 审计抽样技术：统计抽样（属性抽样、变量抽样）、非统计抽样
  - 计算机辅助审计技术（CAAT）：通用审计软件、测试数据等
  - 大数据审计技术：智能分析、可视化分析、多数据源综合分析
- **审计证据**
  - 特性：充分性、客观性、相关性、可靠性、合法性
  - 电子证据：定义、法律地位及处理流程
  - 证据评价因素：提供者独立性、客观性、时效性等
- **审计底稿**
  - 作用：形成结论、评价人员、质量控制、参考备查
  - 分类：综合类、业务类、备查类
  - 编制要求：内容（资料翔实、结论明确）、形式（要素齐全、格式规范）
  - 三级复核制度：负责人、部门、项目负责人复核
- **审计流程**
  - 审计准备阶段：明确目的、组建团队、搜集信息、编制计划
  - 审计实施阶段：调查调整计划、评估内控、符合性测试、实质性测试
  - 审计终结阶段：整理底稿、评价目标、报告发现、沟通结果、归档
  - 后续审计阶段：检查纠正措施、跟踪效果
- **审计内容**
  - **IT内部控制审计**
    - 组织层面：战略、架构、风险管理等
...
- **管理基础**
  - 层次结构：人员、技术、流程、数据
  - 系统管理四大领域：规划和组织、设计和实施、运维和服务、优化和持续改进
- **规划和组织**
  - 规划模型：业务战略、信息系统、组织机制的协同
  - 组织模型：业务战略（总成本领先、差异化、专注化）、组织机制（莱维特钻石模型）、信息系统战略（硬件、软件、网络、数据）
- **设计和实施**
